...
!            uniformCDF = (x-a_c)/(b_c-a_c)
 !       endif
  ...
  !  end subroutine uniformCDF
    ...
    !##############################################################################
   ! subroutine uniformCDF_Inv(x, a, b)
    ! 
     !   implicit none
