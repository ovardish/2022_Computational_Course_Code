...
% algorithm
    ...
    param.maxiter         = 250;             % maximum number of iterations on transition path
...
r_path_t5=round([ones(1,5)*SS.r,TRANS.r],6);
   
figure(1)
plot(-4:1:param.TT,r_path_t5,'LineWidth',2)
xlim([-4,param.TT])
xlabel('t','FontSize',14)
ylabel('r','FontSize',14)
title('interest rate path','FontSize',14)
legend({'trans','trans_SSJ'},'FontSize',12,'Location','SouthEast')

ksupply_t5=round([ones(1,5)*SS.k,TRANS.Ksup],6);
    figure(2)
    plot(-4:1:param.TT,ksupply_t5,'LineWidth',2)
    xlim([-4,param.TT])
    xlabel('t','FontSize',14)
  ...
  wage_t5= round([ones(1,5)*SS.w,TRANS.w],6)  ;
    figure(3)
    plot(-4:1:param.TT,wage_t5,'LineWidth',2)
    xlim([-4,param.TT])
    xlabel('t','FontSize',14)
...
% %     xlabel('t','FontSize',14)
% %     ylabel('r','FontSize',14)
% %     uititle('interest rate path','FontSize',14)
% %     legend({'trans','trans_SSJ'},'FontSize',12,'Location','SouthEast')
% % 
% % 
% %     figure(2)
